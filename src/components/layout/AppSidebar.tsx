...
export const navigationConfig = {
  ...
  aiTools: {
    ...
    items: [
      ...
      { title: "AI Video Summarizer", url: "/ai-video-summarizer", icon: Video },
  ...
  social: {
    ...
    items: [
      ...
      { title: "Mentorship Hub", url: "/mentorship-hub", icon: Users },
  ...
  settings: {
    ...
    items: [
      ...
      { title: "Login Activity", url: "/login-activity", icon: Shield },
      { title: "Feedback", url: "/feedback", icon: MessagesSquare },
      { title: "Feature Requests", url: "/feature-requests", icon: Sparkles },
...
const adminNavigation = [
  ...
  { title: "Landing Selector", url: "/admin/landing", icon: LayoutGrid },

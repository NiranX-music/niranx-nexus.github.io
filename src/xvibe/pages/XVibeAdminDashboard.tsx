...
export default function XVibeAdminDashboard() {
      ...
      for (const item of queue || []) {
        if (item.content_type === 'track') {
          const { data: track } = await supabase
            .from('xvibe_tracks')
            .select('*, xvibe_artists!inner(name)')
          ...
          if (track) {
            items.push({
              ...
              genre: track.genre,
              copyright_risk: item.copyright_score
            });
          }
          ...
          if (album) {
            items.push({
              ...
              type: 'album',
              title: album.title,
              artist_name: album.xvibe_artists?.name || 'Unknown',
  ...
  const handleApprove = async (item: PendingRelease) => {
    try {
      ...
      // Log action
      await supabase.from('xvibe_admin_actions').insert({
        admin_id: user?.id,
        action_type: 'approve',
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">XWave Admin</h1>
              <p className="text-[#B3B3B3]">Content Moderation Dashboard</p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#B3B3B3]">Pending</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#B3B3B3]">Approved</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#B3B3B3]">Rejected</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#B3B3B3]">Flagged</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Tabs defaultValue="queue" className="space-y-6">
          <TabsList className="bg-[#181818] border-none">
            <TabsTrigger value="queue" className="data-[state=active]:bg-[#282828]">
              Moderation Queue
            </TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-[#282828]">
              Action History
            </TabsTrigger>
            <TabsTrigger value="artists" className="data-[state=active]:bg-[#282828]">
              Artists
            </TabsTrigger>
            <TabsTrigger value="reports" className="data-[state=active]:bg-[#282828]">
              Reports
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="queue" className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-[#282828] border-none text-white"
              />
            </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {item.copyright_risk && item.copyright_risk > 50 && (
                    ...
                    {recentActions.map((action) => (
                      <div key={action.id} className="flex items-center justify-between p-3 rounded-lg bg-[#282828]">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-white capitalize">{action.action_type} {action.target_type}</p>
                            <p className="text-sm text-[#B3B3B3]">{action.reason}</p>
                          </div>
                        </div>
          ...
          <TabsContent value="artists">
            <Card className="bg-[#181818] border-none">
              <CardContent className="p-12 text-center">
                <Users className="w-12 h-12 text-[#B3B3B3] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-white mb-2">Artist Management</h3>
                <p className="text-[#B3B3B3]">Manage verified artists and permissions</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="reports">
            <Card className="bg-[#181818] border-none">
              <CardContent className="p-12 text-center">
                <Flag className="w-12 h-12 text-[#B3B3B3] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-white mb-2">Content Reports</h3>
                <p className="text-[#B3B3B3]">Review user-reported content</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
        ...
        <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
          <DialogContent className="bg-[#181818] border-[#282828]">
            <DialogHeader>
              <DialogTitle className="text-white">Reject Content</DialogTitle>
              <DialogDescription className="text-[#B3B3B3]">
                Provide a reason for rejecting "{selectedItem?.title}"
              </DialogDescription>
            </DialogHeader>
            <Textarea
              value={rejectReason}
